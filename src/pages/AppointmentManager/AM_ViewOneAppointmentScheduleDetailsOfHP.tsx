...
interface AppointmentSchedule {
  ...
  const AM_ViewOneAppointmentScheduleDetailsOfHP: React.FC = () => {
    ...
    return (
        <div>
         ...
         <div className='HP_ViewOneAppointmentScheduleDetails_buttonDiv'>
                    <a onClick={handleBackToAppoinment} className="btn btn-primary back_button HP_ViewOneAppointmentScheduleDetailsBackButton"><i className='bi bi-arrow-left-circle'></i> Back to Appointments</a>
...
export default AM_ViewOneAppointmentScheduleDetailsOfHP;
