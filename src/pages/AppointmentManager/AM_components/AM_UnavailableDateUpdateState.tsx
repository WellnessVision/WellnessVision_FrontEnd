...
const AM_UnavailableDateUpdateState: React.FC<HP_HallAvailabilityProps> = ({ show_6, handleClose_6, eventData, roomId }) => {
          ...
          <div className="card-body HP_HallAvailabilityMainDivCard">
            ...
            <div className='HP_HallAvailability_div'>
              {eventData.setDateState === 'Updated' ? (
                ...
                <p className='Unfortunately_text_HP_HallAvailability'>Room Id: {roomId} is not available for appointment booking from {eventData.startDate} onwards</p>
                ...
                <div>
                  ...
                  <p className='Unfortunately_text_HP_HallAvailability'>There are already booked appoinments are available from {eventData.startDate} onwards</p>
                  <div className='HP_HallAvailability_button_div'>
...
export default AM_UnavailableDateUpdateState;