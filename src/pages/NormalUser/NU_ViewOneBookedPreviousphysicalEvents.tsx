...
import NU_ViewMoneyReceiptsDetailsForPreviousEvents from './NU_components/NU_ViewMoneyReceiptsDetailsForPreviousEvents';
import './NU_ViewOneBookedPreviousphysicalEvents.css'
...
interface PhysicalEvent {
  ...
  const NU_ViewOneBookedPreviousphysicalEvents: React.FC = () => {
...
useEffect(() => {
 ...
 if (error) {
  ...
  return (
        <div>
         <NU_Sidebar activeMenuItem={["PreviousPhysicalBooked_Events", "PreviousBooked_Events", "Booked_Events"]}/>
            ...
            <div className="card" style={{ width: '95%' }}>
                ...
                <div className='base_details'>
                    ...
                    <a href="/NU_ViewBookedUpcomingphysicalEvents" className="btn btn-primary back_button NU_ViewOneBookedUpcomingPhysicalEvent_back NU_ViewOneBookedPreviousphysicalEvents_back_hidden"><i className='bi bi-arrow-left-circle'></i> Back to Events</a>
            ...
            <NU_ViewMoneyReceiptsDetailsForPreviousEvents show_2={showPopup_2} handleClose_2={togglePopup_2} MoneyReceiptsDetails={participants} userId={userId} eventId={eventId} hpId={hpId}/>
        </div>
    );
}

export default NU_ViewOneBookedPreviousphysicalEvents;
