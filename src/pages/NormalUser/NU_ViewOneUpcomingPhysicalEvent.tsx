...
interface PhysicalEvent {
  ...
  const NU_ViewOneUpcomingPhysicalEvent: React.FC = () => {
          ...
          <NU_Sidebar activeMenuItem={["PhysicalEvents", "UpcomingEvents", "Events"]}/>
            ...
            <div className="card" style={{ width: '95%' }}>
                ...
                <div className='base_details'>
                    ...
                    <a href="/NU_ViewUpcomingPhysicalEvents" className="btn btn-primary back_button NU_ViewOneUpcomingPhysicalEvent_back_button"><i className='bi bi-arrow-left-circle'></i> Back to Events</a>
                    {(event.hall_capacity > event.ticketBookingCount && checkBookingStateValue === "NotBooked") ? (
                        <a className="btn btn-danger book_button NU_ViewOneUpcomingPhysicalEvent_book_button"
                            onClick={() => handleUserPhysicalEventTemporaryBooking(event.event_id)} >
                            <i className='bi bi-cart-check'></i> Book a Ticket
                        </a>
                        ) : (
                          checkBookingStateValue === "Booked" ? (
...
export default NU_ViewOneUpcomingPhysicalEvent;
