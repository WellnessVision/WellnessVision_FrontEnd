  ...
  return (
    <div>
      ...
      <div style={{ marginLeft: '940px', marginTop: '-635px', width: '500px', backgroundColor: '#b0c4de', borderRadius: '25px', height: '485px'}}>
        <h4 style={{position: 'absolute', marginLeft:'115px', marginTop: '10px'}}>Booked Upcoming Events</h4>
        <div
        ...
        >
          <div className="carousel-inner">
            {bookedeEvents.length > 0 ? (
                ...
                >
                  <div className="card" style={{ width: '18rem' }}>
                    ...
                    <div className="card-body">
                      ...
                      <a
                        onClick={() => handleViewBookedDetails(bookedeEvent.event_id, bookedeEvent.hp_id)}
                        className="btn btn-primary"
                      >
                        <i className="bi bi-eye"></i> View Details
                      </a>
              ...
              <div>
              <p style={{marginTop: '210px', marginLeft: '145px', fontSize: '18px'}}>No booked events available</p>
              <a href="/NU_ViewUpcomingPhysicalEvents" className="btn btn-outline-primary" style={{marginLeft: '185px'}}>Booked Event</a>
              </div>
            )}
          </div>
          <button
