...
const NU_ViewModifyMoneyReceiptsDetails: React.FC<NU_ViewModifyMoneyReceiptsDetailsProps> = ({ show_2, handleClose_2, MoneyReceiptsDetails, userId, eventId, hpId}) => {
...
export default NU_ViewModifyMoneyReceiptsDetails;