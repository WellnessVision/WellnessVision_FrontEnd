...
const NU_ViewOneNotification: React.FC<ViewOneNotificationProps> = ({ show, handleClose, NotificationId}) => {
...
const handleMarkAsParticipate = useCallback(async (notificationId: number, readState: string) => {
    ...
    export default NU_ViewOneNotification;