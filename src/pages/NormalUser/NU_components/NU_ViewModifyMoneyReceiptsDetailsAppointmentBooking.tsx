...
const NU_ViewModifyMoneyReceiptsDetailsAppointmentBooking: React.FC<Nu_ViewModifyMoneyReceiptsDetailsProps> = ({ show_2, handleClose_2, MoneyReceiptsDetails}) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          await axios.put(`http://localhost:15000/updateAppointmentBookingMoneyReceiptsDetailsForNU`, null, {
            params: {
              bookingId: MoneyReceiptsDetails.bookingId,
              accountNumber,
              accountOwnerName,
              branchName,
              bankName
          ...
          navigate(`/NU_ViewOneAppointmentBookingDetails/${MoneyReceiptsDetails.bookingId}/${MoneyReceiptsDetails.bookedAppointmentId}`);
        } 
        catch (err) {
...
export default NU_ViewModifyMoneyReceiptsDetailsAppointmentBooking;