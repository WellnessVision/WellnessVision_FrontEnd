...
const Admin_ViewOneNormalUser: React.FC = () => {
...
const fetchHPdetails = async () => {
        try {
            const response = await axios.get<HP_CardforEventManager>('http://localhost:15000/adminViewOneUserForAdmin?', 
                { params: { userId } }
            );
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <p className="card-text detail" style={{fontSize: '17px', marginTop: '10px'}}><i className='bi bi-award-fill'></i> {hpDetails?.user_id} (User ID)</p>
                            ...
                            <p className="card-text detail" style={{fontSize: '17px'}}><i className='bi bi-soundwave'></i> {hpDetails?.preferences} (Preferences)</p>
                            {hpDetails?.address2 === '' ? (
...
export default Admin_ViewOneNormalUser;
