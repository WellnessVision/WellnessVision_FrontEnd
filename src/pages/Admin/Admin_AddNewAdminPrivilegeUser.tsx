...
import AdminSuccessMessage from './Admin_components/AdminSuccessMessage';
import { useToggle } from '../../pages/HP/useToggle';
import loading_gif from '../../resources/prosecing.gif';
import Admin_Sidebar from './Admin_components/Admin_Sidebar';

const Admin_AddNewAdminPrivilegeUser: React.FC = () => {
    ...
    const [registedId, setRegistedId] = useState('');
    ...
    const handleRegister = async (event: React.FormEvent) => {
        ...
        try {
          ...
          const response = await axios.post('http://localhost:15000/AddNewAdminPrivilegeUserRegistrationForAdmin', formData, {
            headers: {
              'Content-Type': 'multipart/form-data',
            },
          });
          setRegistedId(response.data);
          setSuccessMessage('Admin Privilege User Registretion successfull, Thank you!');
    ...
    return (
        <div className='hp_form'>
            ...
            <div className='form_div' style={{marginTop: '110px', marginLeft: '200px', zIndex: '0'}}>
                <form onSubmit={handleRegister}>
                <label className='hp_header'>New Admin Privilege User Registration</label>
                <h1 className='personal'>Personal Details</h1>
                    ...
                    <div className="form-group">
                            ...
                            >
                                ...
                                <option value="SA">SA (System Admin)</option>
                                <option value="EM">EM (Event Manager)</option>
                                <option value="AM">AM (Appointment Manager)</option>
                            </select>
                    </div>
                    </div>
                    <div className="name-group">
            ...
            {successFlag && <AdminSuccessMessage  show={showPopup} handleClose={togglePopup} message={successMessage} successState={successState} registedId={registedId}/>}
        </div>
    );
};

export default Admin_AddNewAdminPrivilegeUser;
