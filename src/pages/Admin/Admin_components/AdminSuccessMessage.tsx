...
import '../../../components/SuccessMessage.css'
...
const AdminSuccessMessage: React.FC<SuccessMessageProps> = ({ show, handleClose, message, successState, registedId}) => {
    ...
    const handleViewDetails = () => {
        navigate(`/Admin_ViewOneSystemPrivilegeUser/${registedId}`);
    };
