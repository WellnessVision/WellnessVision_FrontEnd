...
import EM_ViewBookingParticipationDetailsForPreviousPhysicalEvents from './EM_components/EM_ViewBookingParticipationDetailsForPreviousPhysicalEvents';
import '../HP/HP_ViewOnePreviousPhysicalEvent.css'
...
interface PhysicalEvent {
  ...
  const EM_ViewOnePreviousPhysicalEvent: React.FC = () => {
  ...
  const handleBackToPreviousEvents = (hpId: number) => {
  ...
  if (!event) {
    ...
    return (
        <div>
            ...
            <div className="card" style={{ width: '95%' }}>
                ...
                <div className='base_details'>
                    ...
                    <a onClick={() => handleBackToPreviousEvents(event.hp_id)} className="btn btn-primary back_button HP_ViewOnePreviousPhysicalEvent_backButton" style={{marginLeft: '600px'}}><i className='bi bi-arrow-left-circle'></i> Back to Events</a>
        ...
        <EM_ViewBookingParticipationDetailsForPreviousPhysicalEvents 
          show_4={showPopup_4} 
...
export default EM_ViewOnePreviousPhysicalEvent;
