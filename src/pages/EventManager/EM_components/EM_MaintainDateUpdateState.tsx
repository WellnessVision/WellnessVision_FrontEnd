...
const EM_MaintainDateUpdateState: React.FC<HP_HallAvailabilityProps> = ({ show_4, handleClose_4, eventData, hallId }) => {
      ...
      <div className="popup-inner popup-inner_HP_HallAvailability">
        <div className="card HP_HallAvailability_fontSize" style={{ width: '100%' }}>
          <div className="card-body HP_HallAvailabilityMainDivCard">
            <h5 className="card-title title_HP_HallAvailability">Phtsical Event Hall(In WellnessVision Premises)</h5>
            ...
            <div className='HP_HallAvailability_div'>
              {eventData.setDateState === 'Updated' ? (
                ...
                <p className='Unfortunately_text_HP_HallAvailability'>Hall Id: {hallId} is not available for physical event booking from {eventData.startDate} to {eventData.endDate}</p>
                ...
                <div>
                  ...
                  <p className='Unfortunately_text_HP_HallAvailability'>There are already booked physical events are available from {eventData.startDate} to {eventData.endDate}</p>
                  <div className='HP_HallAvailability_button_div'>
...
export default EM_MaintainDateUpdateState;