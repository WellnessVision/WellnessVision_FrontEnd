...
interface participationUserDetails {
  ...
  const EM_ViewBookingParticipationDetails: React.FC<HP_ViewBookingParticipationDetailsProps> = ({ show_4, handleClose_4, ParticipationDetails }) => {
...
export default EM_ViewBookingParticipationDetails;
