...
import './HP_ViewPreviousPhysicalEvents.css'
...
const HP_ViewPreviousPhysicalEvents: React.FC = () => {
  ...
  return (
    <div>
      <HPSideBar activeMenuItem={["PreviousPhysicalEvents", "PreviousEvents", "Events"]}/>
      <div className={`blurBackground ${showPopup ? 'blur' : ''}`}>
        <h3 className="header">Previous Events</h3>
        <form className="d-flex search HP_ViewEvents_searchByEventName HP_ViewPreviousPhysicalEvents_searchByEventName" role="search">
             <input 
...
export default HP_ViewPreviousPhysicalEvents;
