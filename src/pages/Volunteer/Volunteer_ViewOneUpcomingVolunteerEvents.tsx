...
interface PhysicalEvent {
  ...
  const Volunteer_ViewOneUpcomingVolunteerEvents: React.FC = () => {
...
const handleChatBox = () => {
  ...
  useEffect(() => {
    const seenTheMessages = async () => {
      try {
        const response = await axios.get(`http://localhost:15000/getMessageCountChatBoxMessageForVolunteerAndPhysicalEventsForBothUsers?`,{
          params: { VolunteerId , eventId, receiver: 'HP' }
        });
...
useEffect(() => {
    const fetchParticipationDetails = async () => {
      try {
        const response = await axios.get<ParticipationDetails>(`http://localhost:15000/getBookingDetailsBookedUpcomingVolunteerPhysicalEventsForVolunteer?`,{
  ...
  }, [ VolunteerId, eventId, setCheckBookingStateValue, setError]);
 ...
 if (error) {
  ...
  return (
        ...
        <Volunteer_Sidebar activeMenuItem={["VolunteerUpcomingEvents", "VolunteerEvent"]}/>
            ...
            <div className="card" style={{ width: '95%' }}>
                ...
                <div className='base_details'>
                    ...
                    <div>
                        ...
                        <button onClick={handleChatBox} className="btn btn-success book_button NU_ViewOneUpcomingPhysicalEvent_hpViewMoreButton Volunteer_ViewOneUpcomingVolunteerEvents_chatBox"> ChatBox 
                        {count > 0 && (
                            <Badge
                            pill
                            bg="danger"
                    ...
                    <a href="/NU_ViewBookedUpcomingphysicalEvents" className={`btn btn-primary back_button NU_ViewOneBookedUpcomingPhysicalEvent_back ${participants.participantState == 'NotParticipate' && event.event_state == 'Upcoming' ? 'Volunteer_ViewOneUpcomingVolunteerEvents_BackButton' : 'NU_ViewOneBookedUpcomingPhysicalEvent_back_hidden Volunteer_ViewOneUpcomingVolunteerEvents_BackButton_hidden'}`}><i className='bi bi-arrow-left-circle'></i> Back to Events</a>
            ...
            <NU_ViewModifyMoneyReceiptsDetails show_2={showPopup_2} handleClose_2={togglePopup_2} MoneyReceiptsDetails={participants} userId={VolunteerId} eventId={eventId} hpId={hpId}/>
...
export default Volunteer_ViewOneUpcomingVolunteerEvents;
