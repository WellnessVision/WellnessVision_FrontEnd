...
const Volunteer_MyEvents_Previous: React.FC = () => {
    ...
    const events = Array(5).fill ({
        ...
        hp_name: "Lalith Abesinghe",
        date: "10/08/2024",
        startTime: 11,
    });

    const handleViewDetails = (eventId: number) => {
        navigate(`/Volunteer_OneEventPrevious/${eventId}`);
      };
                        ...
                        {events.map(event => (
                            <div className="card" style={{ width: '18rem' }} >
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text detail">
                                        <i className="bi bi-heart-pulse-fill"></i> Dr. {event.hp_name}
                                    </p>
                                    <p className="card-text detail">
...
export default Volunteer_MyEvents_Previous;