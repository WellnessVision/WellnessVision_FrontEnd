...
import NU_Sidebar from '../Volunteer/Volunteer_components/Volunteer_Sidebar';
import { parseISO, format } from 'date-fns';
import '../HP/HP_Notification.css'
import Volunteer_ViewOneNotification from './Volunteer_components/Volunteer_ViewOneNotification'; 
import '../NormalUser/NU_Notification.css'
...
const Volunteer_Notification: React.FC = () => {
                        ...
                        events.map(event => (
                            <div className="card mb-3 particepationMarkCards HP_Notification_cardBody" style={{ width: '100%' }} key={event.notification_id}>
                                ...
                                <h5 className="card-title Admin_ViewHealthProfessionalRegistrationRequest_name">Id: {event.notification_id}</h5>
                                    ...
                                    <h5 className="card-title Admin_ViewHealthProfessionalRegistrationRequest_name NU_Notification_notificationTime" style={{marginLeft: '450px'}}>{formatRequestTime(event.notification_time)}</h5>
                                    <span> 
                                    <a
                                className={`btn participantDetailsParticipationMarkButton NU_Notification_markButton ${
                            ...
                            >
                                ...
                                {event.read_state === 'Read' ? 'Read' : 'Mark as Read'}
                                    ...
                                    <a onClick={() => handleViewDetails(event.notification_id)} className="btn btn-primary Admin_ViewHealthProfessionalRegistrationRequest_viewMore NU_Notification_viewMore">
...
export default Volunteer_Notification;
