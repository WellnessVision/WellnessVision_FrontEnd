...
import Volunteer_ChatWithHealthProfessionalReplyPopup from './Volunteer_components/Volunteer_ChatWithHealthProfessionalReplyPopup';
...
interface Message {
 ...
 const formatTime = (hour: number): string => {
  ...
  const Volunteer_ChatWithHealthProfessional: React.FC = () => {
    ...
    const seenTheMessages = async () => {
      try {
        await axios.put(`http://localhost:15000/seenTheChatBoxMessageForVolunteerAndPhysicalEventsForBothUsers`, null, {
          params: { VolunteerId , eventId, sender: 'HP' }
        });
      } catch (error) {
...
const handleChatBoxreplyMessageId = (replyMessageId: number) => {
    navigate(`/Volunteer_ChatWithHealthProfessionalReplyPopup/${replyMessageId}/${eventId}`);
  };

const handleChatBoxEditMessageId = (replyMessageId: number) => {
    navigate(`/Volunteer_ChatWithHealthProfessionalEditMessagePopup/${replyMessageId}/${eventId}`);
  };
  ...
  return (
        ...
        {messages.length > 0 ? (
            messages.map(message => (
              <div className={`cardHang_2 ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_sepatateBySender_Volunteer' : 'Volunteer_ChatWithHealthProfessional_sepatateBySender_Hp'}`}>
                ...
                <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv' style={{zIndex: '3'}}>
                  <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handelDeleteMessage(message.messageId)}>Delete</a></li> : ''}
                  </ul>
                </div>
              ...
              <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv'>
                <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_2' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_2'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
            ...
            <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv Volunteer_ChatWithHealthProfessional_messageWithAttachmentDivOnlyImage'>
              <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_3' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_3'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handelDeleteMessage(message.messageId)}>Delete</a></li> : ''}
            ...
            {message.editFlag === "Yes" && message.sender === 'HP' ?  <p className='Volunteer_ChatWithHealthProfessional_messageContent' style={{marginTop: '-40px', marginLeft: '195px', position: 'absolute'}}>Edited</p> : ''}
                  ...
                  <div style={{zIndex: '0'}}>
                    {message.replyMessageAttachmentFlag === "No" ? (<div style={{zIndex: '0'}}>
                      {message.attachmentFlag === "Yes" && message.messageFlag === "Yes" ? (
                <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv' style={{zIndex: '3'}}>
                  <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_4' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_4'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
              ...
              {message.attachmentFlag === "No" && message.messageFlag === "Yes" ? (
              <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv'>
                <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_5' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_5'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
            ...
            {message.attachmentFlag === "Yes" && message.messageFlag === "No" ? (
            <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv Volunteer_ChatWithHealthProfessional_messageWithAttachmentDivOnlyImage'>
              <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_6' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_6'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handelDeleteMessage(message.messageId)}>Delete</a></li> : ''}
          ...
          {message.editFlag === "Yes" && message.sender === 'HP' ?  <p className='Volunteer_ChatWithHealthProfessional_messageContent' style={{marginTop: '-40px', marginLeft: '195px', position: 'absolute'}}>Edited</p> : ''}
                    ...
                    (<div style={{zIndex: '0'}}>
                      {message.attachmentFlag === "Yes" && message.messageFlag === "Yes" ? (
                <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv'>
                  <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_7' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_7'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
              ...
              {message.attachmentFlag === "No" && message.messageFlag === "Yes" ? (
              <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv' style={{zIndex: '3'}}>
                <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_8' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_8'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handleChatBoxEditMessageId(message.messageId)}>Edit</a></li> : ''}
            ...
            <div className='Volunteer_ChatWithHealthProfessional_messageWithAttachmentDiv Volunteer_ChatWithHealthProfessional_messageWithAttachmentDivOnlyImage' style={{zIndex: '3'}}>
              <div className={`btn-group ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Volunteer_9' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp Volunteer_ChatWithHealthProfessional_replyEditAndDelete_Hp_9'}`}>
                  <button type="button" className={`btn btn-warning dropdown-toggle ${message.sender === 'V' ? 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Volunteer' : 'Volunteer_ChatWithHealthProfessional_replyEditAndDeleteButton_Hp'}`} data-bs-toggle="dropdown" aria-expanded="false"></button>
                  <ul className="dropdown-menu">
                  <li><a className="dropdown-item" onClick={() => handleChatBoxreplyMessageId(message.messageId)}>Reply</a></li>
                    {message.sender === 'V' ? <li><a className="dropdown-item" onClick={() => handelDeleteMessage(message.messageId)}>Delete</a></li> : ''}
...
export default Volunteer_ChatWithHealthProfessional;
