...
import '../pages/Volunteer/Volunteer_components/Volunteer_ChatWithHealthProfessionalEditMessagePopup.css'
...
const formatRequestTime = (time: string): string => {
  ...
  const HP_ChatWithVolunteerEditMessagePopup: React.FC = () => {
...
export default HP_ChatWithVolunteerEditMessagePopup;
