...
const Hp_ViewModifyMoneyReceiptsDetails: React.FC<Hp_ViewModifyMoneyReceiptsDetailsProps> = ({ show_2, handleClose_2, MoneyReceiptsDetails}) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          await axios.put(`http://localhost:15000/updatePhysicalEventMoneyReceiptsDetailsForHP`, null, {
            params: {
              eventId: MoneyReceiptsDetails.event_id,
              accountNumber,
              accountOwnerName,
              branchName,
              bankName
          ...
          navigate(`/HP_OneEvents/${MoneyReceiptsDetails.event_id}`);
...
export default Hp_ViewModifyMoneyReceiptsDetails;