...
interface participationUserDetails {
  ...
  const HP_ViewBookingParticipationDetailsForPreviousPhysicalEvents: React.FC<HP_ViewBookingParticipationDetailsProps> = ({ show_4, handleClose_4, ParticipationDetails }) => {
...
export default HP_ViewBookingParticipationDetailsForPreviousPhysicalEvents;
