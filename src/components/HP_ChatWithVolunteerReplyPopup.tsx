...
import HPSideBar from './HP_SideBar';
...
import '../pages/NormalUser/NU_ViewOneUpcomingPhysicalEvent.css'
import '../pages/NormalUser/NU_ViewOneBookedUpcomingphysicalEvents.css'
import '../pages/Volunteer/Volunteer_ViewOneUpcomingVolunteerEvents.css'
import { Badge } from 'react-bootstrap';
import 'bootstrap-icons/font/bootstrap-icons.css';
import '../pages/Volunteer/Volunteer_ChatWithHealthProfessional.css'
import garbageImage from '../resources/yoga01.png'
import '../pages/Volunteer/Volunteer_components/Volunteer_ChatWithHealthProfessionalReplyPopup.css'
...
interface Message {
 ...
 const formatTime = (hour: number): string => {
  ...
  const HP_ChatWithVolunteerReplyPopup: React.FC = () => {
  ...
  const handleOrderPhysicalEvent = async (event: FormEvent) => {
    ...
    if(newMessage != '' || attachment){
      try {
        ...
        { attachment ? formData.append('attachment', attachment) : ( baseAttachment ? formData.append('attachment', baseAttachment) : '')}
        formData.append('replyFlag', "Yes");
        {messages[0].messageFlag === 'Yes' ?    formData.append('replyMessage', messages[0].message) : (messages[0].attachmentFlag === 'Yes') ?   formData.append('replyMessage', messages[0].attachment) : ''}
        {messages[0].messageFlag === 'Yes' ?   formData.append('replyMessageAttachmentFlag', 'No') : (messages[0].attachmentFlag === 'Yes') ? formData.append('replyMessageAttachmentFlag', 'Yes') : ''}
...
export default HP_ChatWithVolunteerReplyPopup;
