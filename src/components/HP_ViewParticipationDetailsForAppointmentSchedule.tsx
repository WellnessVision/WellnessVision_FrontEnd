...
interface HP_ViewParticipationDetailsForAppointmentSchedule {
  show_4: boolean;
  handleClose_4: () => void;
...
interface participationUserDetails {
  ...
  const HP_ViewParticipationDetailsForAppointmentSchedule: React.FC<HP_ViewParticipationDetailsForAppointmentSchedule> = ({ show_4, handleClose_4, ParticipationDetails, appointmentId }) => {
...
export default HP_ViewParticipationDetailsForAppointmentSchedule;
